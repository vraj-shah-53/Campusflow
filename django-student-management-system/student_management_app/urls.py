...
urlpatterns = [
    ...
    path('admin_student_certification/', HodViews.admin_student_certification, name="admin_student_certification"),
    path('admin_certificate_status/<application_id>/<action>/', HodViews.admin_certificate_status, name="admin_certificate_status"),
    ...
    path('student_fee_payment_save/', StudentViews.student_fee_payment_save, name="student_fee_payment_save"),
    path('student_certificate_apply/', StudentViews.student_certificate_apply, name="student_certificate_apply"),
    path('student_certificate_apply_save/', StudentViews.student_certificate_apply_save, name="student_certificate_apply_save"),
    
    # AI Chatbot
    path('student_chatbot/', StudentViews.student_chatbot, name="student_chatbot"),
]
